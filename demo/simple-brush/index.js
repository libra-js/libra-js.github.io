...
async function main () {
  ...
  renderBrushableScatterPlot(svg, width, height, cars, fieldX, fieldY, fieldColor);
  ...
  function renderBrushableScatterPlot (
    ...
    Libra.GraphicalTransformer.initialize("DrawBackgroundLayer", {
      ...
      sharedVar: { width, height, margin, scaleX, scaleY, scaleColor, fieldX, fieldY, fieldColor },
    });
  }
}
