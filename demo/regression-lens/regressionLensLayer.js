const { Instrument, Layer, InteractionService } = Libra;
...
Layer.register("RegressionLensLayer", {
  ...
  postInitialize: function (layer) {
    ...
    const linearRegressionService = InteractionService.initialize("AnalysisService", {
      algorithm: ({data, fieldX, fieldY}) => {
